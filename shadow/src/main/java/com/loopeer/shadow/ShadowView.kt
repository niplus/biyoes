...
open class ShadowView @JvmOverloads constructor(context: Context?, attributeSet: AttributeSet? = null, defStyleInt: Int = 0)
    ...
    init {
        ...
        shadowRadius = a.getDimensionPixelSize(R.styleable.ShadowView_shadow_radius, SIZE_DEFAULT).toFloat()
        ...
        val cornerRadius = a.getDimensionPixelSize(R.styleable.ShadowView_corner_radius, SIZE_UNSET).toFloat()
        if (cornerRadius >= 0) {
