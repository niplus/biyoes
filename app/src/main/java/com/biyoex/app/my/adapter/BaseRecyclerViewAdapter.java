...
//    private ExpandableListAdapter
    public static final String TAG = drawthink.expandablerecyclerview.adapter.BaseRecyclerViewAdapter.class.getSimpleName();
...
//                mRecyclerView.setScrollingTouchSlop(position + 1);
