...
public class RegexUtils {
     ...
     * 正则：匹配手机号
     */
    public static final String REGEX_TEL           = "0?(13|14|15|17|18|19)[0-9]{9}";
    /**
     * 正则：身份证号码15位
     */
    ...
    public static final String INPUT_FILTER        = "<[^>]*>|\n";
...
//如果传的不是数据返回N
    ...
    public static boolean inputFilter(String input){
        Pattern p = Pattern.compile(INPUT_FILTER);
        Matcher m = p.matcher(input);
        return m.find();
    }
