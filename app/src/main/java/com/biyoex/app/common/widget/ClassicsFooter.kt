...
class ClassicsFooter:LinearLayout,RefreshFooter {
    ...
    override fun onFinish(layout: RefreshLayout, success: Boolean): Int {
        ...
        if (success) {
            mHeaderText!!.text = context.getString(R.string.loading_commit)
        } else {
            mHeaderText!!.setText(context.getString(R.string.load_failure))
        }
