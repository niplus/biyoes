package com.biyoex.app.qrscan.activity;
...
import com.biyoex.app.qrscan.camera.CameraManager;
import com.biyoex.app.qrscan.decoding.CaptureActivityHandler;
import com.biyoex.app.qrscan.decoding.InactivityTimer;
import com.biyoex.app.qrscan.decoding.RGBLuminanceSource;
import com.biyoex.app.qrscan.view.ViewfinderView;
...
//    private ImageView back;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.rl_fall_back).setOnClickListener(v -> finish());
        MPermissionUtils.requestPermissionsResult(this, new MPermissionUtils.OnPermissionListener() {
            ...
            public void onPermissionDenied() {
                finish();
                Toast.makeText(CaptureActivity.this, getString(R.string.save_success), Toast.LENGTH_SHORT).show();
            }
