 ...
 * Kline线买单数据
 * */
class BuyTrendChartAdapter(var context: Context, var priceDecimasl: Int, var amountDecimals: Int) : BaseQuickAdapter<MutableList<String>, BaseViewHolder>(R.layout.item_tranchart_buy) {
    var maxBuy = 0.0;
    ...
    override fun convert(holder: BaseViewHolder?, item: MutableList<String>?) {
        ...
        ratioLinearLayout.setPaintColor(0x00ffffff and mContext.resources.getColor(R.color.price_green) or (0x26 shl 24))
//        ratioLinearLayout.setStartRight(false)
        ...
        holder.setTextColor(R.id.tv_price, mContext.resources.getColor(R.color.price_green))
        //购买币的数量
...
//        holder.setTextColor(R.id.tv_amount, mContext.resources.getColor(R.color.price_green))
